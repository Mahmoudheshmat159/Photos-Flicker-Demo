...
class DateHelper {
    ...
    func date(date: String?, format: String, oldFormat: String = "yyyy-MM-dd HH:mm:ss") -> String? {
        ...
        dateFormatter.locale = Locale(identifier: DateLocale.arabic.rawValue)
        if dateD != nil {
    ...
    func date(date: String?, format: String, oldFormat: String = "yyyy-MM-dd HH:mm:ss", locale: String = DateLocale.arabic.rawValue) -> String? {
        guard let dateUse = date else {return nil}
        let dateD = originalDate(original: dateUse, oldFormat: oldFormat)
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
    ...
    func date(date: Date?, format: String, locale: String = DateHelper.DateLocale.english.rawValue) -> String? {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
        dateFormatter.locale = Locale(identifier: locale)
        if date != nil {
    ...
    func monthNameFromNumber(_ number: Int) -> String{
        let dateFormatter = DateFormatter()
        dateFormatter.locale = Locale(identifier: DateLocale.arabic.rawValue)
